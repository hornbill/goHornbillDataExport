...
platforms="windows/386 windows/amd64 linux/386 linux/amd64 linux/arm darwin/amd64 darwin/arm64"
printf " ---- Building Hornbill Data Export $versiond ---- \n"
printf "\n"
...
do
    ...
    goarch=${split[1]}
    arch=${split[1]}
    output=goHornbillDataExport
    package=goHornbillDataExport
